...
library(Quandl)
oil.ts <- Quandl("DOE/RBRTE", trim_start="1987-11-10", trim_end="2016-01-01", type="zoo")
oil.tsw <-Quandl("DOE/RBRTE", trim_start="1987-11-10", trim_end="2016-01-01", type="zoo", collapse="weekly")
oil.tsm <-Quandl("DOE/RBRTE", trim_start="1987-11-10", trim_end="2016-01-01", type="ts", collapse="monthly")
...
short <- ts(oil.ts[index(oil.ts) > "2015-01-30" & index(oil.ts) < "2015-12-01"], frequency=20)
short.test <- as.numeric(oil.ts[index(oil.ts) >= "2015-12-01",])
h <- length(short.test)
